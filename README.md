...
| :--- | :--- | :--- |
| **Model Context Protocol (MCP)** | [Model Context Protocol Specification](https://github.com/modelcontextprotocol/specification) | Standardized JSON-RPC 2.0 stdio tool interface used by Waymark. |
...
Register Waymark in your agent's MCP configuration (`mcpServers` in Claude Desktop, Cursor, Codex, Gemini / Antigravity, Cline, or `mcp_servers` in Hermes Agent):
...
- **[Multi-Agent Harness Compatibility Guide](docs/HARNESS-COMPATIBILITY.md)**: 3-tier support classification, lifecycle hooks (`waymark-hook`), and multi-harness setup for Claude Code, Cursor, Codex, Antigravity, and Hermes Agent.
