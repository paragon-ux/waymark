# Waymark Harness Integrations

This directory provides concrete, copy-pasteable configuration templates and rule files for AI coding harnesses:

- **[`cc/`](cc/)**: Claude Code integration (`CLAUDE.md` and `post_compact` hook).
